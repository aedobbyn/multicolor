...
*Note*: colors cannot be applied in the R GUI and certain other environments. RStudio or any terminal should work fine<sup>1</sup>. [RMarkdown](https://github.com/aedobbyn/multicolor/blob/master/inst/rmd_example.Rmd) is also in play `r emo::ji("thumbsup")`.
...
You can use [`multicolor` in RMarkdown documents](https://github.com/aedobbyn/multicolor/blob/master/inst/rmd_example.Rmd) with `type = "rmd"`.
