...
Note: this package cannot be run from the R GUI. RStudio or any terminal work fine.
...
The default is to color vertically, but horizontal is also an option. If you want to make a Dutch shark, you can set the `direction` param to "horizontal".
