...
Apply multiple colors to your messages and warnings. Built on the [`crayon`](https://github.com/r-lib/crayon) package. Pairs nicely with [`cowsay`](https://github.com/sckott/cowsay). [Bit of backstory and walkthrough of how it works](https://dobb.ae/2018/07/19/how-does-multicolor-actually-work/).
...
Note: this package cannot be run from the R GUI. RStudio or any terminal should work fine. If coloring isn't possible, you'll get a warning on load.
...
The default is to color vertically, but horizontal is also an option by setting the `direction` param to "horizontal".
